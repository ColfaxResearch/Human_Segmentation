...
def NHWC_hs_model(image, keep_prob):
        ...
        conv_1_ = tf.nn.conv2d(image, kernel_1, [1, 1, 1, 1], padding='SAME')
        out_1 = tf.nn.bias_add(conv_1_, biases_1)
        ...
        conv_2_ = tf.nn.conv2d(pool_1, kernel_2, [1, 1, 1, 1], padding='SAME')
        out_2 = tf.nn.bias_add(conv_2_, biases_2)
        ...
        conv_3_ = tf.nn.conv2d(pool_2, kernel_3, [1, 1, 1, 1], padding='SAME')
        out_3 = tf.nn.bias_add(conv_3_, biases_3)
        ...
        conv_4_ = tf.nn.conv2d(conv_3, kernel_4, [1, 1, 1, 1], padding='SAME')
        out_4 = tf.nn.bias_add(conv_4_, biases_4)
        ...
        conv_5_ = tf.nn.conv2d(conv_4, kernel_5, [1, 1, 1, 1], padding='SAME')
        out_5 = tf.nn.bias_add(conv_5_, biases_5)
        ...
        conv_6_ = tf.nn.conv2d(conv_5, kernel_6, [1, 1, 1, 1], padding='SAME')
        out_6 = tf.nn.bias_add(conv_6_, biases_6)
        ...
        conv_7_ = tf.nn.conv2d(conv_6, kernel_7, [1, 1, 1, 1], padding='SAME')
        out_7 = tf.nn.bias_add(conv_7_, biases_7)
        ...
        conv_8_ = tf.nn.conv2d(conv_7, kernel_8, [1, 1, 1, 1], padding='SAME')
        out_8 = tf.nn.bias_add(conv_8_, biases_8)
